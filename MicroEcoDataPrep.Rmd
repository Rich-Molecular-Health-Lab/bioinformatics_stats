...
sample.table <- metadata  %>% 
                ...
                select(-day) %>%
                mutate(Rep  = n(), .by = subject_day) %>%
                mutate(Time = as.numeric(study_day)) %>%
...
```{r}
dataset.main$sample_table <- data.frame(dataset.main$sample_table, sample.table.merged[rownames(dataset.main$sample_table), ])
dataset.culi$sample_table <- data.frame(dataset.culi$sample_table, sample.table.merged[rownames(dataset.culi$sample_table), ])
dataset.warb$sample_table <- data.frame(dataset.warb$sample_table, sample.table.merged[rownames(dataset.warb$sample_table), ])
```
