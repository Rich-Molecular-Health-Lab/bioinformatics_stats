...
## Check Previous Taxonomy List {.tabset}
...
### First Time - Generate a new representative fasta
...
### Add new taxa to existing representative fasta
...
```{r, warning=FALSE, message=FALSE}
dataset.main$save_table(path$microeco$dataset$main$tax, sep = "\t")
dataset.culi$save_table(path$microeco$dataset$culi$tax, sep = "\t")
dataset.warb$save_table(path$microeco$dataset$warb$tax, sep = "\t")
...
dataset.main$save_alphadiv(path$microeco$alpha$main)
dataset.culi$save_alphadiv(path$microeco$alpha$culi)
dataset.warb$save_alphadiv(path$microeco$alpha$warb)
dataset.main$save_betadiv(path$microeco$beta$main$tax)
dataset.culi$save_betadiv(path$microeco$beta$culi$tax)
dataset.warb$save_betadiv(path$microeco$beta$warb$tax)
```
...
keg.data.main$save_table(path$microeco$dataset$main$keg, sep = "\t")
keg.data.culi$save_table(path$microeco$dataset$culi$keg, sep = "\t")
keg.data.warb$save_table(path$microeco$dataset$warb$keg, sep = "\t")
...
```{r, eval=FALSE}
  keg.data.main$save_abund(path$microeco$abund$main$keg, sep = "\t")
  keg.data.culi$save_abund(path$microeco$abund$culi$keg, sep = "\t")
  keg.data.warb$save_abund(path$microeco$abund$warb$keg, sep = "\t")
keg.data.main$save_betadiv(path$microeco$beta$main$keg)
keg.data.culi$save_betadiv(path$microeco$beta$culi$keg)
keg.data.warb$save_betadiv(path$microeco$beta$warb$keg)
```
