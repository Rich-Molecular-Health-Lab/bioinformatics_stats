...
vis_metadata <- metadata_summary %>%
  ...
  total_kcal = colDef(
    name = "Calories",
    cell = default_nutrients(., 1000, "cal")
  ),
  total_mg_dry = colDef(
    name = "Dry Weight",
    cell = default_nutrients(., .001, "g")
  ...
  holding           = colDef(name = "Holding Facility", cell = icon_sets(metadata_summary, 
                                                                         icon_color_ref = "color_holding",  
                                                                         icons = "house-circle-check")),
  pair_access       = colDef(name = "Pair Access"     , cell = icon_sets(metadata_summary, 
                                                                         icon_ref = "icon_pair_access", 
                                                                         icon_position = "over")),
  warb_status       = colDef(name = "Warble's Status"),
  keeper_note       = colDef(name = "Keeper Notes"),
  Subj_Certainty    = colDef(name = "ID Certainty"    , cell = icon_sets(metadata_summary, 
                                                                         icon_ref = "icon_Subj_Certainty", 
                                                                         icon_position = "over")),
  Sex               = colDef(name = "Sex"             ),
