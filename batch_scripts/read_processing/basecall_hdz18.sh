#!/bin/bash
#SBATCH --time=2:00:00
#SBATCH --job-name=hdz18dorado
#SBATCH --error=/work/richlab/aliciarich/microbiomes_loris/logs/hdz18dorado_%A_%a.err
#SBATCH --output=/work/richlab/aliciarich/microbiomes_loris/logs/hdz18dorado_%A_%a.out
