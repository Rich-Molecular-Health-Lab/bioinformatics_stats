#!/bin/bash
#SBATCH --time=0:45:00
#SBATCH --job-name=hdz18filter
#SBATCH --error=/work/richlab/aliciarich/microbiomes_loris/logs/hdz18filter_%A_%a.err
#SBATCH --output=/work/richlab/aliciarich/microbiomes_loris/logs/hdz18filter_%A_%a.out
